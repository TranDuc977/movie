...
export default function Login(props) {
    ...
    return (
        <div>
            {/* Simple login form */}
            <div style={{ backgroundSize: 'cover', backgroundImage: 'url(https://wallpapercave.com/wp/wp5517221.jpg' }} className=" sm:bg-gray-200 h-screen  bg-center w-screen flex flex-col justify-center items-end ">

                <div style={{ backgroundColor: 'rgb(15, 33, 51)', width: "520px" }} className="  sm:mr-14 shadow-none sm:shadow-lg z-10 px-8 sm:px-12 xs:w-full sm:w-8/12 md:w-7/12 lg:w-7/12 xl:w-2/6 h-screen sm:h-auto py-8">
                        ...
                        <div className="flex flex-col gap-4 px-0 py-4">
                            <div className="form-group">
                                ...
                                <input name="taiKhoan" onChange={formik.handleChange} onBlur={formik.handleBlur}
                                    className="py-2 pl-10 border  form-control bg-gray-300 w-full" placeholder="Nhập tài khoản" type="text" />
                            ...
                            <div>
                                ...
                                <input onBlur={formik.handleBlur} name="matKhau" onChange={formik.handleChange} className="py-2 pl-10 border  form-control bg-gray-300 w-full" placeholder="Nhập mật khẩu" type="password" />
                            ...
                            <div className="w-full flex flex-row gap-2">
                                <button className="border border-indigo-500 hover:bg-indigo-500 hover:text-white duration-100 ease-in-out w-6/12 text-green-400 rounded-md p-0 flex flex-row justify-center items-center gap-1" type="submit">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                                    </svg> Đăng nhập
                                </button>
                                <NavLink to="/register" className="border border-indigo-500 hover:bg-indigo-500 hover:text-white duration-100 ease-in-out w-6/12 text-green-400 rounded-md p-2 flex flex-row justify-center items-center gap-1">
                            ...
                            <div className="my-2 flex flex-row justify-center">
                                <span className="absolute bg-gray-300  text-green-600 rounded-md px-4">hoặc</span>
                                <div className="w-full bg-gray-200 mt-3" style={{ height: 1 }} />
                            </div>
                            <div className="w-full flex flex-col gap-2">
                                <button className="bg-red-500 twl w-full p-2 flex flex-row justify-center gap-2 items-center hover:bg-red-600 duration-100 ease-in-out">
                                ...
                                <button className="bg-blue-600 twl w-full p-2 flex flex-row justify-center gap-2 items-center hover:bg-blue-700 duration-100 ease-in-out">
                                ...
                                <button className="bg-gray-700 twl w-full p-2 flex flex-row justify-center gap-2 items-center hover:bg-gray-800 duration-100 ease-in-out">
                            ...
                            <div className="w-full flex flex-row justify-between">
                                ...
                                <a className="text-green-600" href="#">Quên mật khẩu</a>
                            </div>
                        </div>
                    </form>
                </div>
