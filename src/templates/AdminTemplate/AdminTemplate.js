...
const AdminTemplate = (props) => { //path, exact, Component
    ...
    const operations = <Fragment>
        {!_.isEmpty(userLogin) ? <Fragment> <button onClick={() => {
            history.push('/home')
        }}> <div style={{ width: 50, height: 50, display: 'flex', justifyContent: 'center', alignItems: 'center' }} className="text-2xl mx-4 rounded-full bg-red-200">{userLogin.taiKhoan.substr(0, 1)}</div></button>
             <button onClick={() => {
            ...
            <Layout style={{ minHeight: '100vh' }}>
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        ...
                        <div className="site-layout-background" style={{ padding: 24, minHeight: '85vh', background: '#fff' }}>
